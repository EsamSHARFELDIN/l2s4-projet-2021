...
public class ExampleBoard extends Board {
    ...
    private void populate() {
        this.tiles = new Tile[][]{
        	...
        	// 3rd row
        	{new OceanTile(0, 2), new OceanTile(1, 2), new OceanTile(2, 2), new OceanTile(3, 2), new PlainTile(4, 2), new DesertTile(5, 2), new OceanTile(6, 2)},
        	// 4th row
        	...
        	// 6th row
        	{new OceanTile(0, 5), new OceanTile(1, 5), new OceanTile(2, 5), new OceanTile(3, 5), new PlainTile(4, 5), new DesertTile(5, 5), new OceanTile(6, 5)},
        };
    }
}
